...
export default function CertificateCard({ cert, language, index, onClick }: CertificateCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-44 overflow-hidden bg-muted">
        ...
        {/* Status badge */}
        <span className={`absolute top-3 right-3 text-xs px-2.5 py-1 rounded-full border backdrop-blur-sm flex items-center gap-1.5
          ${isExpired
