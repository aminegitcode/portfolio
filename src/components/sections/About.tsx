...
const About = ({ profile }: AboutProps) => {
  ...
  return (
    <section id="about" className="py-5 pt-23 bg-background/20 relative">
      <div className="absolute inset-0 z-0 pointer-events-none bg-gradient-to-b from-transparent via-primary/4 to-transparent" />
      ...
      <div className="container mx-auto px-10 lg:px-20 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-secondary/30 rounded-full blur-xl pointer-events-none" />
              <motion.div
                animate={{ y: [0, -10, 0] }}
        ...
        >
          <div className="absolute top-2 right-4 w-16 h-16 bg-primary/20 rounded-full blur-xl pointer-events-none" />
          <div className="absolute -bottom-4 -left-2 w-12 h-12 bg-primary/20 rounded-full blur-lg pointer-events-none" />
          <div className="absolute top-3 left-4 text-primary opacity-30 pointer-events-none">
            <Quote size={25} />
          </div>
